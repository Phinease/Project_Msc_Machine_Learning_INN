...
white_path = "data/raw/exported_white_2022-06-29-13-52-21.png"
...
for img_path in tqdm(img_files, ascii=True, ncols=100):
    ...
    hsi_data = HSImage(array=copy.deepcopy(img), wavelengths=None, camera="imec 4x4-VIS-15.7.10.12")
    # hsi_data.reconstruct(white=copy.deepcopy(white), dark=None, rho=10, method="flatfield")
